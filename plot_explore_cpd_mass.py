...
ax.plot(mod_inferior[:,0:1]-shift,mod_inferior[:,1:2],label=r'$M_\mathrm{CPD}=0.001 \, M_\mathrm{p}$',linewidth=lwidth,color="mediumpurple")
ax.plot(mod_mean[:,0:1]-shift,mod_mean[:,1:2],label=r'$M_\mathrm{CPD}=0.01 \, M_\mathrm{p}$',linewidth=lwidth,color="lightcoral")
ax.plot(mod_superior[:,0:1]-shift,mod_superior[:,1:2],label=r'$M_\mathrm{CPD}=0.1 \, M_\mathrm{p}$',linewidth=lwidth,color="cornflowerblue")
